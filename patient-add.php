...
<html lang="en" dir="ltr">
	...
	<body class="layout-default">
						...
						<form class="container-fluid page__container">
							<div class="card card-form">
								<div class="row card-form__body card-body">
									...
									<h4 class="col-12 border-bottom-2 pb-2 mb-3">Patient Details</h4>
									...
									<div class="form-group col-md-3">
										...
										<input type="text" name="disease_duration" class="form-control">
									</div>
		...
		<script>
			(function() {
				document.getElementById("patient").classList.add("active", "open");
			})();
		</script>
